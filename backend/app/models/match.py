...
class MatchModel(BaseModel):
    ...
    # rVFC prototype fields - separate video paths for dual-video sync
    left_video_path: Optional[str] = Field(None, description="Left camera video path (for rVFC dual-video mode)")
    right_video_path: Optional[str] = Field(None, description="Right camera video path (for rVFC dual-video mode)")
    audio_offset: Optional[float] = Field(None, description="Audio offset in seconds (right = left + offset)")
