...
mod tests {
    use super::*;
    use reco_core::calibration::{Calibration, FieldRoi, Framing, LShapeTopology, Lens};
    ...
    fn test_scene(calibration: &Calibration) -> SceneGeometry {
        let aspect = calibration.lenses[0].width as f32 / calibration.lenses[0].height as f32;
        SceneGeometry::for_calibration(calibration, aspect)
    }
