...
- Interactive panorama preview with pan/zoom via mouse + keyboard (driven by `reco-control::PoseControl`, oriented at the render site by `reco-core`'s `StitchCore::orient_pose`).
