...
test("bundled packages honor template typography", () => { for (const packageId of packageIds) assert.match(readPackageFile(packageId, "scoreboard.js"), /applyTypography/); });
