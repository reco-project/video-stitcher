(function universalScoreboardDesigner() {
    ...
    const elements = {
        ...
        form: document.querySelector("#state-form"), message: document.querySelector("#editor-message"), toggleEditing: document.querySelector("#toggle-editing"), canvasToolbar: document.querySelector("#canvas-toolbar")
    };
    ...
    let dragState = null; let editingEnabled = true; let selectedTarget = "scoreboard";
