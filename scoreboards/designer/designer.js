(function universalScoreboardDesigner() {
    ...
    const elements = {
        ...
        form: document.querySelector("#state-form"), message: document.querySelector("#editor-message"), toggleEditing: document.querySelector("#toggle-editing"), modeTabs: document.querySelector("#mode-tabs"), modeTemplate: document.querySelector("#mode-template"), modeGame: document.querySelector("#mode-game"), panelTitle: document.querySelector("#state-panel-title"), panelKicker: document.querySelector("#state-panel-kicker"), templateHelp: document.querySelector("#template-help"), publishState: document.querySelector("#publish-state"), downloadState: document.querySelector("#download-state"), canvasToolbar: document.querySelector("#canvas-toolbar"), typographyTarget: document.querySelector("#typography-target"), typographyFontFamily: document.querySelector("#typography-font-family"), typographySize: document.querySelector("#typography-size"), typographyWeight: document.querySelector("#typography-weight"), typographyStyle: document.querySelector("#typography-style"), typographyColor: document.querySelector("#typography-color"), templateFreeLogoUpload: document.querySelector("#template-free-logo-upload"), templateHomeLogoUpload: document.querySelector("#template-home-logo-upload"), templateAwayLogoUpload: document.querySelector("#template-away-logo-upload"), gameHomeLogoUpload: document.querySelector("#game-home-logo-upload"), gameAwayLogoUpload: document.querySelector("#game-away-logo-upload")
    };
    ...
    function ensureCustomState() {
        state.custom ??= {};
        state.custom.scoreboard ??= { x: 430, y: 120, scale: 0.62 };
        state.custom.freeText ??= { text: "created with", x: 1640, y: 940, scale: 1, color: "#fff", visible: true };
        state.custom.freeLogo ??= { src: "assets/reco-logo.png", x: 1800, y: 940, scale: 0.8, visible: true }; state.custom.typography ??= {}; for (const [key, value] of Object.entries(typographyDefaults)) state.custom.typography[key] ??= { ...value };
    }
    ...
    function renderPlacement() {
        ensureCustomState();
        setPreviewPosition(elements.card, state.custom.scoreboard, 430, sport === "soccer" ? 120 : 120, 0.62);
    ...
    function render() {
        ...
        renderPlacement(); renderTeamLogos(); renderTypography(); renderTypographyControls();
